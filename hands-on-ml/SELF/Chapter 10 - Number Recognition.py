...
model_location = os.path.join(os.path.dirname(current_path), "OUTPUT/Chapter10")
data_path = data_path = os.path.join(os.path.dirname(current_path), "DATA/Chapter3")

# load the model 
model = tf.keras.models.load_model(os.path.join(model_location, 'my_mnist_model.keras'))
