""" Find the best place for hositals to be in a city """
...
class Space():
    ...
    def hill_climb(self, maximum=None, image_prefix=None, log=False):
        ...
        if image_prefix:
            self.output_image(f"data/{image_prefix}{str(count).zfill(3)}.png")
    ...
    def random_restart(self, maximum, image_prefix=None, log=False):
        ...
        for i in range(maximum):
            ...
            if image_prefix:
                self.output_image(f"data/{image_prefix}{str(i).zfill(3)}.png")
...
# hospitals = s.hill_climb(image_prefix="hill_climb_hospitals", log=True)
hospitals = s.random_restart(maximum=40, image_prefix="random_restart_hospitals", log=True)