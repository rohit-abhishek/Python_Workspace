...
model_location = os.path.join(os.path.dirname(current_path), "output/video22")
data_path = data_path = os.path.join(os.path.dirname(current_path), "data/video22")

# load the model 
model = tf.keras.models.load_model(os.path.join(model_location, 'mnist_conv2d.keras'))
